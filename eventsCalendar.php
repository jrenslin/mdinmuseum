...
<body>
    ...
    <header>
        <h1>
            <a id="pageTitle" href="./">
                ...
                <span id="HeaderMoreParts">Veranstaltungskalender</span>
            </a>
        </h1>
    </header>
    ...
    echo '
        <section class="mdCalendar"
            ...
            data-today="./eventsCalendar.php?y=' . date("Y") . '&m=' . date("m") . '"
            data-prev="./eventsCalendar.php?y=' . date("Y", $prevMonth) . '&m=' . date("m", $prevMonth) . '"
            data-next="./eventsCalendar.php?y=' . date("Y", $nextMonth) . '&m=' . date("m", $nextMonth) . '"
            data-src="' . htmlspecialchars($settings['baseURL']) . '/index.php?t=events&calendar=1&y=' . $y . '&m=' . $m . "&instnr=" . $settings['instnr'] . '&output=json">
        </section>
    ';
    ?>
